...
if ET
    gcnt = 0; 
    EyeData.mx=nan(1,ceil(exp.totalTime*framerate));
    EyeData.my=nan(1,ceil(exp.totalTime*framerate));
    EyeData.ma=nan(1,ceil(exp.totalTime*framerate));
    EyeData.FixDoneT = nan(1,ceil(exp.totalTime*framerate));
    EyeData.gazeD = nan(1,ceil(exp.totalTime*framerate));
    EyeData.Fixated = nan(1,ceil(exp.totalTime*framerate));
end
