function LD_phantom_rivalry_v4(subject, session, debug)
...
ex.conds = {'MinbgLeftVel3','MinbgRightVel3','MeanbgLeftVel3', 'MeanbgRightVel3', 'LightbgLeftVel3', 'LightbgRightVel3', 'NophLeft', 'NophRight' ...%,
...
Screen('FillRect',coLaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth+(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window
...
Screen('FillRect',coRaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth + (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth-(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window


%phantom condition 1
ph1Laperture=Screen('OpenOffscreenwindow', w, gray2);
Screen('FillRect',ph1Laperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth + xc) yc-(3/2)*ex.gaborHeight xc+(ex.gaborWidth-xc)/2 yc-ex.gaborHeight/2]); %bottom grating window
Screen('FillRect',ph1Laperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth + xc) yc+ex.gaborHeight/2 xc+(ex.gaborWidth-xc)/2 yc+(3/2)*ex.gaborHeight]); %top grating window
Screen('FillRect',ph1Laperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth+(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window


ph1Raperture=Screen('OpenOffscreenwindow', w, gray2);
Screen('FillRect',ph1Raperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth - xc) yc-(3/2)*ex.gaborHeight xc+(ex.gaborWidth+xc)/2 yc-ex.gaborHeight/2]); %bottom grating window
Screen('FillRect',ph1Raperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth - xc) yc+ex.gaborHeight/2 xc+(ex.gaborWidth+xc)/2 yc+(3/2)*ex.gaborHeight]); %top grating window
Screen('FillRect',ph1Raperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth + (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth-(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window

ph2Laperture=Screen('OpenOffscreenwindow', w, gray2);
Screen('FillRect',ph2Laperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth + xc) yc-(3/2)*ex.gaborHeight xc+(ex.gaborWidth-xc)/2 yc-ex.gaborHeight/2]); %bottom grating window
Screen('FillRect',ph2Laperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth + xc) yc+ex.gaborHeight/2 xc+(ex.gaborWidth-xc)/2 yc+(3/2)*ex.gaborHeight]); %top grating window
Screen('FillRect',ph2Laperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth+(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window


ph2Raperture=Screen('OpenOffscreenwindow', w, gray2);
Screen('FillRect',ph2Raperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth - xc) yc-(3/2)*ex.gaborHeight xc+(ex.gaborWidth+xc)/2 yc-ex.gaborHeight/2]); %bottom grating window
Screen('FillRect',ph2Raperture, [255 255 255 0], [xc-(1/2)*(ex.gaborWidth - xc) yc+ex.gaborHeight/2 xc+(ex.gaborWidth+xc)/2 yc+(3/2)*ex.gaborHeight]); %top grating window
Screen('FillRect',ph2Raperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth + (xc*1.5/2)) yc-ex.probeHeight/2 xc+(ex.probeWidth-(xc*1.5/2))/2 yc+(1/2)*ex.probeHeight]); %opposite eye grating window
    ...
    while n <= length(ex.trialFlips)
        ...
        if contains(condName, 'Minbg')
            ...
            if nnz(find(ex.longFormStimOnSecs(n)))
                ...
                elseif contains(condName, 'Right')
                    ...
                    ex.rectLRect =  CenterRectOnPoint([0 0 ex.rawGaborWidth ex.rawGaborHeight],xc+xc/2+xOffset,yc);
                    ex.lcRRect =  CenterRectOnPoint([0 0 ex.rawProbeWidth ex.rawProbeHeight],xc-(xc*3/8),yc);
                    % stim
        ...
        elseif contains(condName, 'Lightbg')
            ...
            if nnz(find(ex.longFormStimOnSecs(n)))
                ...
                if contains(condName, 'Left')
                    xOffset = ex.stimLongDriftPos(cLightL,l,cntLightL,n)-ex.stimLongDriftPos(cLightL,l,cntLightL,1); %baseline correct the position since every image already hase a spatial phase shift in the sinewave
                    ex.rectLRect =  CenterRectOnPoint([0 0 ex.rawGaborWidth ex.rawGaborHeight],xc-xc/2+xOffset,yc);
                    ex.lcLRect =  CenterRectOnPoint([0 0 ex.rawProbeWidth ex.rawProbeHeight],xc+(xc*3/8),yc);
                    
                    % stim
                    Screen('DrawTexture', w, ex.lcSWaveID(oriNum),[],ex.lcLRect);
                    Screen('DrawTexture', w, ex.rectSWaveID(cLightL,l,cntLightL),[],ex.rectLRect);
                    Screen('DrawTexture',w,ph2Laperture);
                    Screen('DrawDots', w, [xc/2 yc], ex.fixSize, [255 255 255], [], 2);
                    Screen('DrawDots', w, [xc*3/2 yc], ex.fixSize, [255 255 255], [], 2);
                elseif contains(condName, 'Right')
                    xOffset = ex.stimLongDriftPos(cLightR,l,cntLightR,n)-ex.stimLongDriftPos(cLightR,l,cntLightR,1); %baseline correct the position since every image already hase a spatial phase shift in the sinewave
                    ex.rectLRect =  CenterRectOnPoint([0 0 ex.rawGaborWidth ex.rawGaborHeight],xc+xc/2+xOffset,yc);
                    ex.lcRRect =  CenterRectOnPoint([0 0 ex.rawProbeWidth ex.rawProbeHeight],xc-(xc*3/8),yc);
                    
                    % stim
                    Screen('DrawTexture', w, ex.lcSWaveID(oriNum),[],ex.lcRRect);
                    Screen('DrawTexture', w, ex.rectSWaveID(cLightR,l,cntLightR),[],ex.rectLRect);
