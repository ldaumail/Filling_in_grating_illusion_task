%function LD_phantom_mri_V1(subject, session, vertOffset, debug) 
subject = 1;
session = 1;
debug = 1;
vertOffset = 0;
...
if debug == 1
    ...
    exp.gammaCorrect = 0;       % make sure this = 1 when you're at the scanner!

else
    exp.screenWidth = 16;             % in cm; %laptop=27.5,office=43, %19=%T3b, miniHelm=39;
    exp.viewingDist = 23;             % in cm; %3Tb/office=43, miniHelm=57;
