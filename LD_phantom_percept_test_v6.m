function LD_phantom_percept_test_v6(subject, session, debug)
...
ex.blockLength = ex.trialFixation + 11;%119; %ex.trialFixation+ ceil(ex.stimDur*ex.stimsPerBlock);           % in seconds
...
ex.lcstim.contrast = 0.2; %0.03;%linspace(0.01,0.20,10);%[0.05, 0.10, 0.15];                                                 % in %, maybe?? %here the number of stimulus contrast levels is the number of different conditions
