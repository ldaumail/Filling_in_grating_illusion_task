...
plotdir = strcat('/Users/loicdaumail/Documents/Research_MacBook/Tong_Lab/Projects/Prototype_phantom_FEM/anal_plots/');
saveas(gcf,strcat(plotdir, sprintf('%sbg_electrooculogram_loic10112022.png',savename)));
saveas(gcf,strcat(plotdir, sprintf('%sbg_electrooculogram_loic10112022.svg',savename)));
...
plotdir = strcat('/Users/loicdaumail/Documents/Research_MacBook/Tong_Lab/Projects/Prototype_phantom_FEM/anal_plots/');
saveas(gcf,strcat(plotdir, sprintf('%sbg_norm_stdx_loic10112022.png',savename)));
saveas(gcf,strcat(plotdir, sprintf('%sbg_norm_stdx_loic10112022.svg',savename)));
...
plotdir = strcat('/Users/loicdaumail/Documents/Research_MacBook/Tong_Lab/Projects/Prototype_phantom_FEM/anal_plots/');
saveas(gcf,strcat(plotdir, sprintf('%sbg_norm_stdy_loic10112022.png',savename)));
saveas(gcf,strcat(plotdir, sprintf('%sbg_norm_stdy_loic10112022.svg',savename)));
