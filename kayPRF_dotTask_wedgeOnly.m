function kayPRF_dotTask_wedgeOnly(subject, session, vertOffset, debug, rot)
...
run.masks = 'WedgeOnly';     % 'Multibar' or 'WedgeRing';
...
if strcmp(rot, 'CCW')
    idxs = 1:480;
elseif strcmp(rot, 'CW')
    idxs = 480:-1:1;
end
maskInds = [zeros(1,330), repmat(idxs,1,8), zeros(1,330)];
