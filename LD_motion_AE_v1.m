function LD_motion_AE_v1(subject, session, debug, vertOffsets, horiOffsets)
...
ex.conds = {'MinbgPairLeftVel3','MinbgTopLeftVel3', 'MinbgBotLeftVel3',...
    ...
    'LightbgPairLeftVel3', 'LightbgTopLeftVel3','LightbgBotLeftVel3', 'NophLeft' ...%,
...
ex.stimOnSecs = [ones(1,ex.blockLength(t)) zeros(1,ex.betweenBlocks)]; %zeros(1,ex.trialFixation) 
...
ex.stim.tempPhase1 = nan(nconds,length(ex.stim.contrastOffset), max(ex.repsPerRun));
ex.stim.tempPhase2 = nan(nconds,length(ex.stim.contrastOffset), max(ex.repsPerRun));
% ex.stim.oscillation1 = nan(nconds,length(ex.stim.contrastOffset), max(ex.repsPerRun),length(ex.stim.flipTimes));
%ex.stim.oscillation2 = nan(nconds,length(ex.stim.contrastOffset), max(ex.repsPerRun),length(ex.stim.flipTimes));
...
%             ex.stim.oscillation1(c,l,r,:) = %ex.stim.cycPerSec*ex.stim.flipTimes+ex.stim.tempPhase1(c,l,r); %cos(2*pi*(1/ex.stimDur(1))*ex.stim.flipTimes+ex.stim.tempPhase1(c,l,r));
%             ex.stim.oscillation2(c,l,r,:) = ; %cos(2*pi*(1/ex.stimDur(2))*ex.stim.flipTimes+ex.stim.tempPhase2(c,l,r));
%             ex.stim.spatialPhase = 90;
            ex.stim.phases(c,l,r,:) = (1:length(ex.stim.flipTimes))*ex.stim.dphase(1);%(ex.stim.oscillation1(c,l,r,:).*180*ex.stim.cycles(1)+ ex.stim.oscillation2(c,l,r,:).*180*ex.stim.cycles(2))/2 + ex.stim.spatialPhase; %./ex.stimDur-2*pi*flipTimes./ex.stimDur make it oscillatory
        end
    end
end
...
ex.stimDriftPosDeg = nan(nconds,length(ex.stim.contrastOffset), max(ex.repsPerRun),length(ex.stim.phases(1,1,1,:)));
...
for c = 1:nconds
    for l =1:length(ex.stim.contrastOffset)
        for r = 1:max(ex.repsPerRun)
            ex.stimDriftPosDeg(c,l,r,:) = ex.stim.phases(c,l,r,:); %(ex.stim.oscillation1(c,l,r,:).*ex.stim.cycles(1).*1/(2*ex.stim.spatialFreqDeg)); %+ ex.stim.oscillation2(c,l,r,:).*ex.stim.cycles(2).*1/(2*ex.stim.spatialFreqDeg))/2;
...
Screen('FillRect',coLPaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',coLTaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',coLBaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',coRaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(1) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(1) xc+(ex.probeWidth+xc)/2+horiOffsets(1) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(1)]); %opposite eye grating window
...
Screen('FillRect',ph1LPaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph1LTaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph1LBaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph1Raperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(1) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(1) xc+(ex.probeWidth+xc)/2+horiOffsets(1) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(1)]); %opposite eye grating window
...
Screen('FillRect',ph2LPaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph2LTaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph2LBaperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(2) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(2) xc+(ex.probeWidth+xc)/2+horiOffsets(2) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(2)]); %opposite eye grating window
...
Screen('FillRect',ph2Raperture, [255 255 255 0], [xc-(1/2)*(ex.probeWidth - xc)+horiOffsets(1) yc-ex.probeHeight/2+ex.lcstim.distFromFix+vertOffsets(1) xc+(ex.probeWidth+xc)/2+horiOffsets(1) yc+(1/2)*ex.probeHeight+ex.lcstim.distFromFix+vertOffsets(1)]); %opposite eye grating window
...
%         if c == length(ex.condShuffle) & n == length(ex.longFormBlocks)
%             break
%         end
...
%                     Screen('DrawTexture', w, ex.lcSWaveID(oriNum),[],ex.lcRRect);
        ...
        if (cnt/2 == 1 && GetSecs-time >= 0) && c ~= length(ex.condShuffle)
            ...
            ex.lcLRect =  CenterRectOnPoint([0 0 ex.rawProbeWidth ex.rawProbeHeight],xc+xc/2+horiOffsets(2),yc+ex.lcstim.distFromFix+vertOffsets(2));
            % stim
            Screen('DrawTexture', w, ex.lcSWaveID(l),[],ex.lcLRect);
            %             Screen('DrawTexture',w,coLPaperture);
            Screen(w, 'Flip', 0);
            WaitSecs(ex.initialFixation);
